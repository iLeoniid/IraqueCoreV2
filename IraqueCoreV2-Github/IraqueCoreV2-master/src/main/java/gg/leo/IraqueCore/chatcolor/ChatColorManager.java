...
public class ChatColorManager {
    ...
    private void loadColors() {
        ...
        Bukkit.getConsoleSender().sendMessage(plugin.getConfigManager().deserialize(
                "<#1a1a1a>    </#1a1a1a><#2d6a4f>\u2714</#2d6a4f> <#a8dadc>Chat Colors</#a8dadc> <#6c757d>(" + colors.size() + ")</#6c757d>"
        ));
    }
